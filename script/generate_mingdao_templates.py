...
TABLES = [
    ...
    },
    {
        ...
        "upsert": "独立站 + 页面URL",
        "fields": [
            ("独立站", "单选", "脚本", "cncpioneer|fecision|richconn|lasermicrofab|drametal", "Upsert键", "single", "cncpioneer"),
            ("页面URL", "链接", "GSC", "", "Upsert键；GSC自动导入", "url", "https://www.cncpioneer.com/"),
            ("运营页面类型", "单选", "人工", "服务页|产品页|博客页|材料页|行业页|工艺页|案例页|询盘页", "导入后改单选", "single", "产品页"),
            ("Ahrefs页面类型", "文本", "API", "", "只读", "text", "Product"),
            ("主关键词", "文本", "API", "", "Ahrefs Top keyword", "text", "cnc machining"),
            ("主词搜索量", "数值", "API", "", "0位", "int", 1200),
            ("Ahrefs首次发现", "日期", "API", "", "first_seen", "date", dt.date(2024, 3, 1)),
            ("优化日期", "日期", "人工", "", "", "date", dt.date(2026, 5, 1)),
            ("优化记录", "多行文本", "人工", "", "导入后改多行文本", "longtext", "更新H1与首段"),
            ("质量校验", "单选", "人工", "合格|待整改|不合格", "导入后改单选", "single", "合格"),
            ("收录状态", "单选", "GSC", "已收录|未收录|索引异常", "导入后改单选", "single", "已收录"),
            ("GSC点击", "数值", "GSC", "", "0位", "int", 15),
            ("GSC展示量", "数值", "GSC", "", "0位", "int", 320),
            ("GSC平均CTR", "数值", "GSC", "", "4位小数", "decimal", 0.047),
            ("GSC平均排名", "数值", "GSC", "", "1位小数", "decimal", 12.3),
            ("数据日期", "日期", "脚本", "", "", "date", dt.date(2026, 5, 27)),
            ("URL权重UR", "数值", "API", "", "1位小数", "decimal", 12.0),
            ("排名关键词数", "数值", "API", "", "Ahrefs Keywords列", "int", 48),
            ("页面字数", "数值", "API", "", "Ahrefs Words列", "int", 1398),
            ("Ahrefs月流量", "数值", "API", "", "0位", "int", 500),
            ("Ahrefs流量价值", "数值", "API", "", "2位小数美元", "decimal", 120.50),
        ],
    },
    {
        "file": "04-SEO每日执行日志.xlsx",
        "upsert": "日期 + 运营人",
        "fields": [
